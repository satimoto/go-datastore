...
INSERT INTO users (
  ...
  RETURNING id, linking_pubkey, pubkey, device_token, node_id, commission_percent, is_admin, referrer_id
`
...
SELECT id, linking_pubkey, pubkey, device_token, node_id, commission_percent, is_admin, referrer_id FROM users
  WHERE id = $1
`
